...
/**
 * MILDLYPOPULARSTATE For a channel to be in this state, its popularity score
 * should be in the range (1000, 10000]
 * 
 * @author Ramesh Chowdarapally
 *
 */

public class MILDLYPOPULARSTATE extends AbstractState implements StateI {
	...
	public String addVideo(String video) throws videoExistException {
		...
		return StateName.MILDLY_POPULAR + "__" + Operation.VIDEO_ADDED + "::" + video;
	}
	...
	public String removeVideo(String video) throws removeVideoException {
		...
		return StateName.MILDLY_POPULAR + "__" + Operation.VIDEO_REMOVED + "::" + video;
	}
	...
	public String metricsVideo(String video, int views, int likes, int dislikes)
		...
		return StateName.MILDLY_POPULAR + "__" + Operation.POPULARITY_SCORE_UPDATE + "::" + super.iAvgPS;
	}
	...
	public String adRequest(String video, int adLength) throws adRequestException {
		...
		return StateName.MILDLY_POPULAR + "__" + Operation.AD_REQUEST + "::" + strAcceptence;
	}
}
