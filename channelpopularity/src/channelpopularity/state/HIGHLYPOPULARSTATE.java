...
/**
 * HIGHLYPOPULARSTATE For a channel to be in this state, its popularity score
 * should be in the range (10000, 100000]
 * 
 * @author Ramesh Chowdarapally
 *
 */

public class HIGHLYPOPULARSTATE extends AbstractState implements StateI {
	...
	public String addVideo(String video) throws videoExistException {
		...
		return StateName.HIGHLY_POPULAR + "__" + Operation.VIDEO_ADDED + "::" + video;
	}
	...
	public String removeVideo(String video) throws removeVideoException {
		...
		return StateName.HIGHLY_POPULAR + "__" + Operation.VIDEO_REMOVED + "::" + video;
	}
	...
	public String metricsVideo(String video, int views, int likes, int dislikes) throws decinLikeException, decinDisikeException{
		...
		return StateName.HIGHLY_POPULAR + "__" + Operation.POPULARITY_SCORE_UPDATE + "::" + super.iAvgPS;
	}
	...
	public String adRequest(String video, int adLength) throws adRequestException {
		...
		return StateName.HIGHLY_POPULAR + "__" + Operation.AD_REQUEST + "::" + strAcceptence;
	}
}
